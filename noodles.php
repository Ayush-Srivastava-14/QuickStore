...
<link rel="stylesheet" type="text/css" href="m1ststyle.css">
	<title>Noodles Page</title>
</head>
<body>
	<h2>Showing Noodles Products</h2>
	<?php 

$query="select * from product where type='noodle' ";
...
while($row=mysqli_fetch_assoc($result)){
	...
	?>
  	...
  	<img border="0" alt="Maggie" src='uploads/<?php echo $row['image']; ?>' width="200" height="200">
